...
<?php
	if(isset($_POST["submit"]))
	{
		...
		else
		{
			...
			{
				$_SESSION["errormessage"]="Oops Something went wrong.Post failed to add.Please try after some time.";
			}
		}
	}
?>
						...
						<form action="" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									...
									<textarea class="form-control" type="text" name="post" id="post" required></textarea>
								</div>
								<br>
								<input class="btn btn-success btn-block" type="submit" name="submit" value="Add New Post"></input>
							</fieldset><br>
						</form>
					</div>
				</div>
